...
# $9: zoomed pdf 
# ${10}: cbra limit 
# ${11}: reassigned bed tsv file
# ${12}: layered plot gplt
# ${13}: layered pdf 
# ${14}: ylimits for layered plot
...
############### Do with and without straight line ######### 
...
#################################### with line ############################ 
################################################ break between different length range ############# 
## four ranges I am defining ##

# first break the limits
# 
