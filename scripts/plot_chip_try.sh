...
echo "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Command %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
echo "Rscript scripts/boxplot_chip_p_val_fixed.R ${1}_${7}_tmp.tsv 1 2 $2 $4 "${3}-${5}" "Cluster "  "Cluster" "Mean ChIP \(${13}\)"  "${7}" $8 $9 ${10} ${11} ${12}  ${14} ${15} $1 ${16} ${17}" 
echo "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Command %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
Rscript scripts/boxplot_chip_p_val_fixed.R ${1}_${7}_tmp.tsv 1 2 $2 $4 "${3}-${5}" "Cluster "  "Cluster" "Mean ChIP (${13})"  "${7}" $8 $9 ${10} ${11} ${12}  ${14} ${15} $1 ${16} ${17}
